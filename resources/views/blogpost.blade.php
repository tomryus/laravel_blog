...
@push('nav')
    <ul class="nav-menu nav navbar-nav">
        ...
        <li class="cat-{{$no}}"><a href="#">{{$item->nama_category}}</a></li>
        @php
            $no++;
        @endphp
        @endforeach
                ...
                <div class="section-row sticky-container">
                    <div class="main-post">
                        ...
                        <figure class="figure-img">
                            <img class="img-responsive" src="{{asset('uploads/'. $post->picture)}}" alt="">
                            <figcaption>Keterangan gambar on the way</figcaption>
                        </figure>
                        {!! $post->body !!}
                    </div>
                ...
                <div class="aside-widget">
                    ...
                    <div class="category-widget">
                        <ul>
                            ...
                            @foreach ($parsing as $item)
                            <li><a href="#" class="cat-1">{{$item->nama_category}}<span>{{$item->article_count}}</span></a></li>    
                            @endforeach
